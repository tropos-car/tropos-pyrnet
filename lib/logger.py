...
# %% ../nbs/processing/lib_logger.ipynb 12
...
# %% ../nbs/processing/lib_logger.ipynb 14
def parse_adc(s):
    '''
    Parse an ADC record
...
# %% ../nbs/processing/lib_logger.ipynb 16
dtype_gprmc = [
    ( 'time',   'datetime64[ms]' ),
    ( 'status', 'S1' ),
    ( 'lat',    'f8' ),
...
# %% ../nbs/processing/lib_logger.ipynb 22
...
# %% ../nbs/processing/lib_logger.ipynb 34
...
# %% ../nbs/processing/lib_logger.ipynb 36
...
# %% ../nbs/processing/lib_logger.ipynb 39
def read_logger(
        fname : str,
        *,
        station: int,
