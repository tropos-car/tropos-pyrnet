...
# %% auto 0
__all__ = ['logger', 'update_coverage_meta', 'merge_ds', 'to_netcdf', 'get_config', 'get_cfmeta', 'to_l1a', 'to_l1b']
...
def to_l1b(
    ...
    now = pd.to_datetime(np.datetime64("now"))
    ds_l1b.attrs["history"] = ds_l1b.history + f"{now.isoformat()}: Generated level l1b  by pyrnet version XX; " #TODO add version
